...
public class TeamBBench : MonoBehaviour
{
    ...
    private void OnMouseDown()
    {
        ...
        if (isClicked)
        {
            // desativando a permissão para posicionar um jogador do time A
            gridManager.placeA = false;
            //ativando/desativando a permissão para posicionar um jogador do time B
            gridManager.placeB = !(gridManager.placeB);
            // Debug.Log(gridManager.placeB); //Debug message
